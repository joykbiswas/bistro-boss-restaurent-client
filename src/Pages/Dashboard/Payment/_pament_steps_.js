 ...
 * install stripe intent post on the get client secret. make sure you used the payment method types: ['card]
 * 
 * 6.from client side get thr client secret and save it.
